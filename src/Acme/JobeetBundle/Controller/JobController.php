...
class JobController extends Controller
{
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        // Sore the job as an array so we can put it in
        // the session and avoid entity serialize errors
        $job = array(
            'id' => $entity->getId(),
        ...
        // $this->get('session')->getFlashBag()->add('notice', 'This is a notice flashbag');
